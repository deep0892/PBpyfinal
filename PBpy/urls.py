...
from TextToSpeech.views import pollyexotel,CommonIVRCall,getfinaldetails,hardcopyrecievalIVR,hardcopycallbackIVR,get_url,saveExotelResponse,maptoSP
...
urlpatterns = [
    ...
    url(r'^texttospeech/CommonIVRCall',CommonIVRCall ),
